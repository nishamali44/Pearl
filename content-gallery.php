 ...
 */
 ...
 <article id="post-<?php the_ID(); ?>" <?php post_class( 'pearl-format-gallery' ); ?>>
 	<header class="entry-header text-center">
 		
 		<?php if( pearl_get_attachment() ): ?>
 			
 			<div id="post-gallery-<?php the_ID(); ?>" class="carousel slide pearl-carousel-thumb" data-ride="carousel">
 				
 				<div class="carousel-inner" role="listbox">
 					
 					<?php 
 						
 						$attachments = pearl_get_bs_slides( pearl_get_attachment(7) );
 					...
 					<div class="table">
 						<div class="table-cell">
 							...
 							<div class="preview-container">
 								...
 								<span class="pearl-icon pearl-circle-left" aria-hidden="true"></span>
 				...
 				<a class="right carousel-control" href="#post-gallery-<?php the_ID(); ?>" role="button" data-slide="next">
 					<div class="table">
 						<div class="table-cell">
 							...
 							<div class="preview-container">
 								<span class="thumbnail-container background-image"></span>
 								<span class="pearl-icon pearl-circle-right" aria-hidden="true"></span>
